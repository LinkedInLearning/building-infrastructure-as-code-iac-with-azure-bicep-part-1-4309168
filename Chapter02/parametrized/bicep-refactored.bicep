...
param webAppName string = '${appNamePrefix}-webapp36'
param appServicePlanName string = '${appNamePrefix}-appplan36'
param appInsightsName string = '${appNamePrefix}-appinsights36'
param appStorageAccountName string = format('{0}stg36', replace(appNamePrefix, '-', ''))
param vNetName string = '${appNamePrefix}-vnet36'
